...
function Projects() {
  const project = [
    ...
    {
      title: "Operationalization of Machine Learning Microservice API",
      description:
        "Operationalised a Machine Learning Language which logs data based on predictions. Code written on AWS Cloud9 and the code pushed to Dockerhub and GitHub. CircleCI setup for CI/ CD pipeline. Pass badge set up in README file.",
      url: "https://github.com/jossydee1/project-ml-microservice-kubernetes",
    },
    {
      title: "DevOps Project",
      description: "Official website of Dana Group",
      url: "https://github.com/jossydee1/DevOps-Project1_AppCode",
    },
  ];
